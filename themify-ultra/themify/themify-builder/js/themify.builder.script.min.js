...
this.filter("img"),m=e.length;e.bind("load.imgloaded",function(){0>=--m&&"data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw=="!==this.src&&(e.unbind("load.imgloaded"),b.call(e,this))}).each(function(){if(this.complete||void 0===this.complete){var b=this.src;this.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==";this.src=b}});return this})})(jQuery);
